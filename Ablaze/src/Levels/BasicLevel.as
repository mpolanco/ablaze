...
package Levels
{
	...
	{
		//Embedded media...
		[Embed(source="../../csv/levelCSV_Basic_Group1_Map2.csv", mimeType="application/octet-stream")] public var CSV_Group1Map2:Class;
		[Embed(source="../../assets/art/background.png")] public var Img_Group1Map2:Class;
		[Embed(source="../../csv/levelCSV_Basic_Group1_Map1.csv", mimeType="application/octet-stream")] public var CSV_Group1Map1:Class;
		[Embed(source="../../assets/art/tiles.png")] public var Img_Group1Map1:Class;
		...
		public function BasicLevel(addToStage:Boolean = true, onAddSpritesCallback:Function = null)
		{
			// Generate maps.
		...
		{
			addSpriteToLayer(Player, Group2Layer1Group , 48.000, 144.000, 0.000, false, 1, 1, onAddCallback );//"Ember"
		}
