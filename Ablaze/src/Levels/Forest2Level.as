...
{
	import org.flixel.*;
	public class Forest2Level extends BaseLevel
	{
		//Embedded media...
		...
		public function Forest2Level(addToStage:Boolean = true, onAddSpritesCallback:Function = null)
		{
			// Generate maps.
		...
		{
			addSpriteToLayer(Player, PlayerEmberGroup , 32.000, 304.000, 0.000, false, 1, 1, onAddCallback );//"Ember"
		}
