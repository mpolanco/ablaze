...
{
	import org.flixel.*;
	public class Forest5Level extends BaseLevel
	{
		//Embedded media...
		[Embed(source="../../csv/levelCSV_Forest5_Map_Background.csv", mimeType="application/octet-stream")] public var CSV_MapBackground:Class;
		[Embed(source="../../assets/art/temp_background.png")] public var Img_MapBackground:Class;
		[Embed(source="../../csv/levelCSV_Forest5_Map_Platforms.csv", mimeType="application/octet-stream")] public var CSV_MapPlatforms:Class;
		[Embed(source="../../assets/art/tileset.png")] public var Img_MapPlatforms:Class;
		[Embed(source="../../csv/levelCSV_Forest5_FrontFX_Fade.csv", mimeType="application/octet-stream")] public var CSV_FrontFXFade:Class;
		...
		public function Forest5Level(addToStage:Boolean = true, onAddSpritesCallback:Function = null)
		{
			// Generate maps.
		...
		{
			addSpriteToLayer(Player, PlayerEmberGroup , 48.000, 192.000, 0.000, false, 1, 1, onAddCallback );//"Ember"
		}
