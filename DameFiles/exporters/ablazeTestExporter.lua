...
tileMapClass = "FlxTilemap"--as3.tolua(VALUE_TileMapClass);
mainLayer = "MapPlatforms"--as3.tolua(VALUE_MainLayer)
levelName = "Test"--as3.tolua(VALUE_LevelName)
...
flixelVersion = "2.5"--as3.tolua(VALUE_FlixelVersion)
...
function exportMapCSV( mapLayer, layerFileName )
	...
	-- TODO: export name should be dependent on level name
	DAME.WriteFile(csvDir.."/"..layerFileName, mapText );
end

-- This is the file for the map level class.
fileText = "//Level code generated by custom Ablaze level exporter!\n\n"
fileText = fileText.."package Levels\n"
fileText = fileText.."{\n"
fileText = fileText..tab1.."import org.flixel.*;\n"

--if # importsText > 0 then
--	fileText = fileText..tab1.."// Custom imports:\n"..importsText.."\n"
--end

fileText = fileText..tab1.."public class "..levelName.."Level extends BaseLevel\n"
...
for groupIndex = 0,groupCount do
	...
	for layerIndex = 0,layerCount do
		...
		if isMap == true then
			-- TODO: edit mapFileName
			mapFileNameNoExt = "levelCSV_"..levelName.."_"..groupName.."_"..layerSimpleName
			mapFileName = mapFileNameNoExt..".csv"
			...
			--fileText = fileText..tab2.."public var CSV_"..layerName..":Class = Assets."..mapFileNameNoExt.."CSV;"
			...
			--imgNoExt = string.sub(layer.imageFile,0,-4)

			--fileText = fileText..tab2.."public var Img_"..layerName..":Class = Assets.".."imgNoExt".."PNG;"
...
fileText = fileText.."\n"
fileText = fileText..tab2.."public function "..levelName.."Level(addToStage:Boolean = true, onAddSpritesCallback:Function = null)\n"
...
for i,v in ipairs(spriteLayers) do
	-- TODO: does BaseLevel really need this empty function? ... not having this could allow us to have one, master BaseLevel class for all the levels
	...
	-- TODO: no need to override this function anymore
...
-- Save the file!
-- TODO: change filenames to be dependent on level name
DAME.WriteFile(as3Dir.."/"..levelName.."Level.as", fileText )
-- TODO: don't need to export baselevel everytime
