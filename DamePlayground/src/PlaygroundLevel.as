package
{
	...
	public class PlaygroundLevel extends FlxGroup
	{
		protected var background:FlxTilemap;
		protected var map:FlxTilemap;
		
		public function PlaygroundLevel(mapCSV:Class, mapTilesPNG:Class, backgroundCSV:Class, backgroundTilesPNG:Class)
		{
			super();
